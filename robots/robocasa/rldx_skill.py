"""RLDX-1 closed-loop grasp/contact skill for the RoboCasa interactive driver.
...
class RLDXSkill:
    def __init__(self, env_adapter, vla_client=None):
        ...
        # the VLA rollout is closed-loop over 100s of sim-steps but the driver only dumps
    ...
    VLA_OBS_RES = 256   # matches the eval: robocasa365 gym_wrapper get_camera_config renders
                        ...
                        # Verified: eval gym obs are (256,256,3) and driver@256 is byte-identical.
