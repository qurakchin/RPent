...
class RoboCasaToolkit(Toolkit):
    ...
    def __init__(
        ...
        *,
        ...
        """Create a RoboCasa toolkit, wiring the primitive driver and tools."""
    ...
    def _step(self, name: str, **kwargs) -> dict:
        """Run ``self._driver.<name>(**kwargs)`` and return the rendered state view.

        Dispatches the primitive action, records elapsed time, dumps the
        new step, and returns the rendered driver state view.
        """
    ...
    def init_driver_clean(
        ...
        *,
        ...
        driver = RoboCasaPrimitives(**primitives_kwargs)
        driver.reset()
